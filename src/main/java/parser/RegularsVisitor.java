...
public interface RegularsVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link RegularsParser#anynonmetacharacter}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitAnynonmetacharacter(@NotNull RegularsParser.AnynonmetacharacterContext ctx);
